defmodule Kcl do
  ...
  """
  def shared_secret(our_private, their_public), do: our_private |> Curve25519.derive_shared_secret(their_public) |> first_level_key
  ...
  def box(msg, nonce, our_private, their_public), do: box(msg, nonce, our_private |> Kcl.State.init |> Kcl.State.new_peer(their_public))
  ...
  def unbox(packet, nonce, our_private, their_public), do: packet |> unbox(nonce, our_private |> Kcl.State.init |> Kcl.State.new_peer(their_public))
